...
namespace HurPsyWinForms
{
    public partial class StimulusView : UserControl
    {
        ...
        public void SetLocation(HurPsyPoint exploc)
        {
            TrialView? trview = this.Parent as TrialView;
            if (trview != null)
            {
                Point pf = new Point();
                ...
                switch (exploc.OriginChoice)
                {
                    ...
                    case HurPsyOrigin.MiddleCenter:
                        pf.Offset(trview.ClientRectangle.Width / 2, trview.ClientRectangle.Height / 2);
                        break;
                }
        ...
        public void SetSize(HurPsySize expsz)
        {
            TrialView? trview = this.Parent as TrialView;
            if (trview != null)
            {
